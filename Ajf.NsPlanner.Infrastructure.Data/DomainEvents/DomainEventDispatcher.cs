...
namespace Ajf.NsPlanner.Infrastructure.Data.DomainEvents
{
    ...
    public class DomainEventDispatcher : IDomainEventDispatcher
    {
        ...
        public void Dispatch(BaseDomainEvent domainEvent)
        {
            ...
            IEnumerable handlers = (IEnumerable)_serviceProvider.GetService(typeof(IEnumerable<>).MakeGenericType(handlerType));
