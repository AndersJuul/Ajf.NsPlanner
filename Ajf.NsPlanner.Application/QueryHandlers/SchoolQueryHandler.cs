...
{
    public class SchoolQueryHandler : IQueryHandler<SchoolQuery, SimpleStatTable>
    {
        public SimpleStatTable Handle(SchoolQuery query)
        {
            var summary = (from a in query.Assignments
                orderby a.EventRequest.SchoolInstituteName
                     group a by a.EventRequest.SchoolInstituteName
                into grp
            ...
            dt.Clear();
            dt.Columns.Add("SchoolInstituteName");
